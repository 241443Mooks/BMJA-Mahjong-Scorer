...
import { publicGamePathForRulesProfile } from '../game/rules-presentation';
...
export function ReturnToGame() {
  ...
  const href = publicGamePathForRulesProfile(recovered.game.setup.rulesProfile);
  if (!href) return null;
