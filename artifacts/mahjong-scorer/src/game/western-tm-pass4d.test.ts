...
const cases: Case[] = [
  ...
  { id: 'two-odd-suits-and-one-even-suit', name: 'Odds & Evens', value: 1500, hand: l([...r('bamboo',[1,3,5,7,9]),...r('characters',[1,3,5,7,9]),...r('circles',[2,4,6,8])]), miss: l([...r('bamboo',[1,3,5,7,9]),...r('characters',[1,3,5,7,9]),...r('circles',[2,4,6,3])]) },
...
describe('western-tm@0.1 Companion Pass 4D verification', () => {
  ...
  it('finds representative fishing paths and Dragon’s Tail exposure values', () => {
    ...
    expect(find({ ...cases[6]!.hand, isWinner: false, looseTiles: cases[6]!.hand.looseTiles!.slice(0,-1) }, cases[6]!.id)?.fishingValue).toBe(600);
