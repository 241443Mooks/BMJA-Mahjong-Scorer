  ...
  return <div className="mahjong-shell">
    ...
    <main className="mx-auto max-w-[980px] px-5 py-10 lg:px-8 lg:py-14">
      ...
      <section className="rounded-xl border border-[#b8cdbf] bg-[#edf3ed] p-5 text-[16px] leading-7 text-[#284d45]">
        <strong>Rules matter.</strong> This detailed explanation is for British / BMJA-style settlement. Settlement is profile-owned, so other supported rules may differ. See <a className="font-semibold underline decoration-[#ae6249] underline-offset-4" href="/rules">the rules hub</a> for current profile support and boundaries.
      </section>
