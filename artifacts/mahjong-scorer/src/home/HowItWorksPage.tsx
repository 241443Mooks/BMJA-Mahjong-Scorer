      ...
      <main className="mx-auto max-w-[1100px] px-5 py-9 lg:px-8 lg:py-14">
        <article className="overflow-hidden rounded-2xl border border-[#d8ceb8] bg-[#fbf8ed] shadow-[var(--shadow-sm)]">
          <section className="border-b border-[#ddd3bf] px-5 py-9 sm:px-8 sm:py-12 lg:px-12 lg:py-14">
            ...
            <p className="mt-5 max-w-[760px] text-[15px] leading-7 text-[#596b65]">British Mahjong Scorer is designed around evidence rather than guesswork. You give it the hand and game context you actually have; it calculates the supported score, explains the reasoning, and carries confirmed results into settlement and the game record.</p>
