...
export function AtlasExampleVisual({ example, title }: { example: AtlasExample; title?: string }) {
  ...
  return <figure className="mt-4 rounded-xl border border-[#dfd5c2] bg-[#fdfbf5] p-3 sm:p-4">
    ...
    {example.kind === 'tile-hand-generator' && !generatedVisual && <p className="mt-3 rounded-lg bg-[#efe8da] p-3 text-sm text-[#284d45]">A tile layout is not available for this hand under these rules.</p>}
