...
The executable `western-tm@0.1` profile is provisional. It currently reuses the BMJA-compatible British/Western base for ordinary scoring, validation, tile values, bonus tiles, doubles, wind treatment, settlement, progression and ordinary winner handling. These domains are recorded as **provisional-compatible**, not primary-source-verified identity. Special-hand catalogue membership is not shared by that assumption: each Western binding needs its own evidence. Its verified bindings are Three Great Scholars (1,500 winning / 600 fishing), Unique Wonder (2,000 / 800), All Pair Honours (1,000 / 400), Four Blessings (1,500 / 600), All Winds and Dragons (1,000 / 400), and Heads and Tails (1,000 / 400); the Companion catalogue index retains their source page and edition references. Do not create `western-tm@1.0` while those executable provisional assumptions remain.
