...
- Crazy Chows uses `four-mixed-chows-with-mixed-pair`: the complete loose layout is four Mixed Chows plus a Mixed Pair; 500 / 200 fishing. The Full Synopsis p.56 appears to give 1,000 / 400, but the authoritative detail p.16 explicitly labels it HALF LIMIT / Fishing 200; the binding follows the detail page.
